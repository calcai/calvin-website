  ...
  return (
    ...
    <div>
      ...
      <div className = "container-fluid">
        <div className = "row"><div className = "col"><Experience1/></div><div className = "col"><Experience2/></div></div>
      </div>
      ...
      <div className = "container-fluid">
        ...
        <div className = "row"><div className = "col"><Card3/></div><div className = "col"><Card5/></div></div>
